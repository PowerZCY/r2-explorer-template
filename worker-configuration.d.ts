/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f9266d40c6b40de901e7b121b05344cb)
...
declare namespace Cloudflare {
	interface Env {
		...
		API_TOKEN: string;
		BUCKET_DEFAULT_API_TOKEN: string;
		BUCKET_NEWSPAPER_API_TOKEN: string;
		BUCKET_ASPECT_API_TOKEN: string;
		R2_CUSTOM_DOMAIN: string;
		BUCKET_DEFAULT_CUSTOM_DOMAIN: string;
		BUCKET_NEWSPAPER_CUSTOM_DOMAIN: string;
		BUCKET_ASPECT_CUSTOM_DOMAIN: string;
		SHARE_LINK_EXPIRES_HOURS: string;
		PUBLIC_LINK_EXPIRES_HOURS: string;
		FTP_DEFAULT_API_TOKEN: string;
		FTP_API_TOKEN: string;
		FTP_ASPECT_API_TOKEN: string;
		FTP_DEFAULT_DOMAIN: string;
		FTP_DOMAIN: string;
		FTP_ADMIN_PASSWORD: string;
		bucket: R2Bucket;
		bucket_newspaper: R2Bucket;
		bucket_aspect: R2Bucket;
		ASSETS: Fetcher;
	}
}
...
interface IncomingRequestCfPropertiesBotManagementBase {
    ...
    /**
     * A boolean value that is true if the request matches [file extensions](https://developers.cloudflare.com/bots/reference/static-resources/) for many types of static resources.
     */
